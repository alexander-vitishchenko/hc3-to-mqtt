...
## How to use
<ol>
<li>Download the latest <a href="https://github.com/alexander-vitishchenko/hc3-to-mqtt/releases/latest/download/hc3_to_mqtt_bridge-1.0.188.fqa">QuickApp</a>, and then upload it your Fibaro Home Center 3 instance
<br><br>
